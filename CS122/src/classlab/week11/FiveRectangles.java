...
public class FiveRectangles extends Application{
	...
	public void start(Stage primaryStage) {
		...
		for(int i = 0; i < 5; i++) {
			rectangles[i] = new Rectangle(r.nextInt(500)+10, r.nextInt(91) + 10);
		...
		Scene scene = new Scene(null, 600, 600, Color.BLUEVIOLET);
